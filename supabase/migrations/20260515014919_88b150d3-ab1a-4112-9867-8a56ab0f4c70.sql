...
BEGIN
  ...
  -- Reuse any existing clinic tied to this auth user if the function is retried.
...
'Automatically and idempotently provisions clinic, profile, owner role, owner professional and default tenant seeds when a user signs up.';
...
export const TEMPLATE_ESTETICA_FACIAL: DynamicField[] = [
  ...
  },
  {
    ...
    config: {
      ...
      options: [
        { id: 'tipo_1', label: 'Tipo 1', description: 'Pigmentação constitucional. Coloração acastanhada leve ao redor dos olhos, de origem genética.', image_placeholder_key: 'estetica/periocular/tipo_1', image_url: null, display_order: 1 },
        { id: 'tipo_2', label: 'Tipo 2', description: 'Edema periorbital. Inchaço ao redor dos olhos causado por acúmulo de líquido nos tecidos perioculares.', image_placeholder_key: 'estetica/periocular/tipo_2', image_url: null, display_order: 2 },
        { id: 'tipo_3', label: 'Tipo 3', description: 'Vascular de localização superficial. Olheiras arroxeadas ou azuladas causadas por vasos sanguíneos visíveis sob a pele fina periocular.', image_placeholder_key: 'estetica/periocular/tipo_3', image_url: null, display_order: 3 },
        { id: 'tipo_4', label: 'Tipo 4', description: 'Depressão do sulco lacrimal (tear trough). Aparência escurecida causada pela perda de volume e depressão anatômica na região infraorbital.', image_placeholder_key: 'estetica/periocular/tipo_4', image_url: null, display_order: 4 },
        { id: 'tipo_5', label: 'Tipo 5', description: 'Hiperpigmentação pós-inflamatória. Escurecimento residual resultante de processos inflamatórios como dermatite, alergia ou trauma local.', image_placeholder_key: 'estetica/periocular/tipo_5', image_url: null, display_order: 5 },
        { id: 'tipo_6', label: 'Tipo 6', description: 'Envelhecimento. Hiperpigmentação com rugas, perda de elasticidade e dano actínico cumulativo.', image_placeholder_key: 'estetica/periocular/tipo_6', image_url: null, display_order: 6 },
      ],
    },
  },

  ...
  },
  {
    ...
    config: {
      ...
      options: [
        ...
        { id: 'tipo_2', label: 'Tipo 2', description: 'Vascular. Olheiras arroxeadas ou azuladas causadas por vasos sanguíneos visíveis sob a pele fina.', image_placeholder_key: 'estetica/periocular/tipo_2', image_url: null, display_order: 2 },
        { id: 'tipo_3', label: 'Tipo 3', description: 'Pós-inflamatória. Hiperpigmentação resultante de processos inflamatórios como dermatite ou alergia.', image_placeholder_key: 'estetica/periocular/tipo_3', image_url: null, display_order: 3 },
        { id: 'tipo_4', label: 'Tipo 4', description: 'Sombra por perda de volume. Aparência escurecida causada pela depressão do sulco nasojugal (tear trough).', image_placeholder_key: 'estetica/periocular/tipo_4', image_url: null, display_order: 4 },
        { id: 'tipo_5', label: 'Tipo 5', description: 'Flacidez palpebral. Escurecimento associado a excesso de pele e frouxidão dos tecidos perioculares.', image_placeholder_key: 'estetica/periocular/tipo_5', image_url: null, display_order: 5 },
